...
default_config = TRLConfig(
    ...
    optimizer=OptimizerConfig(name="adamw", kwargs=dict(lr=1e-6, betas=(0.9, 0.95), eps=1.0e-8, weight_decay=1.0e-6)), # 0.1 rmsprop
...
def main(config: DictConfig):
    ...
    # config_path=f"{os.getcwd()}/conf/config.yaml" ##### Do I need this?? 
