...
source /admin/home-laura/venvs/venv-trlx/bin/activate
...
accelerate launch --gradient_accumulation_steps 1 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="70m" train.batch_size=8 train.checkpoint_interval=200 train.eval_interval=100 train.run_name="70_test" 
# accelerate launch --gradient_accumulation_steps 1 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="160m" train.batch_size=8 train.checkpoint_interval=200 train.eval_interval=100 train.run_name="160m_adamw_1e-06_zero2" 
# accelerate launch --gradient_accumulation_steps 1 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="410m" train.batch_size=8 train.checkpoint_interval=200 train.eval_interval=100 train.run_name="410m_adamw_1e-06_zero2" 
# accelerate launch --gradient_accumulation_steps 1 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="1b" train.batch_size=8 train.checkpoint_interval=200 train.eval_interval=100 train.run_name="1b_adamw_1e-06_zero2" 
# accelerate launch --gradient_accumulation_steps 2 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="1.4b" train.batch_size=4 train.checkpoint_interval=500 train.eval_interval=500 train.run_name="1.4b_adamw_1e-06_zero2" 
# accelerate launch --gradient_accumulation_steps 4 --config_file conf/zero2-bf16.yaml scripts/ppo_hh.py model.model_size="2.8b" train.batch_size=2 train.checkpoint_interval=1000 train.eval_interval=100 train.run_name="2.8b_adamw_1e-06_zero2" # 2 bs * 4 grad_acc * 8 gpus = 128 total_bs AND 96000/16 ~6000 steps
